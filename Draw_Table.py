...
highlight = False
# colors
colors = [('alkali metals', '#1B67C9'),
          ('metalloids', '#F5B659'),
          ('actinides', '#572356'),
          ('alkaline earth metals', '#A166A0'),
          ('reactive nonmetals', '#00B6BC'),
          ('unknown properties', '#859998'),
          ('transition metals', '#F53951'),
          ('post-transition metals', '#F36D4A'),
          ('noble gases', '#329090'),
          ('lanthanides', '#004E75')]
...
def draw_screen(data):
    ...
    for i in range(len(data)):
        ...
        screen.blit(font.render(elem[1], True, 'white'), (x_pos + 5, y_pos + 5))
        screen.blit(font.render(elem[2], True, 'white'), (x_pos + 5, y_pos + 20))
